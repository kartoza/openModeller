...
OmgClimateDataProcessorGui::OmgClimateDataProcessorGui(QWidget* parent, Qt::WFlags fl)
    : QDialog(parent,fl) 
{
  /**
...
void OmgClimateDataProcessorGui::accept()
{
  writeSettings();
  done(1);
}

void OmgClimateDataProcessorGui::on_pbnSelectFile_clicked()
{
  /**
...
void OmgClimateDataProcessorGui::on_pbnSelectDir_clicked()
{
  /**
...
void OmgClimateDataProcessorGui::on_pbnProcess_clicked()
{
  /**
  writeSettings();
...
void OmgClimateDataProcessorGui::readSettings()
{
  /**
  QSettings mySettings;
...
void OmgClimateDataProcessorGui::writeSettings()
{
  /**
  QSettings mySettings;
...
void OmgClimateDataProcessorGui::error(QString theError)
{
  /**
...
void OmgClimateDataProcessorGui::message(QString theMessage)
{
  /**
...
void OmgClimateDataProcessorGui::updateProgress (int theCurrentValue, int theMaximumValue)
{
  /**
