...
#ifndef OMGEXPERIMENTDESIGNER_H
#define OMGEXPERIMENTDESIGNER_H

#include <ui_omgexperimentdesignerbase.h>
...
class OmgExperimentDesigner : public QDialog, public Ui::OmgExperimentDesignerBase
{
  Q_OBJECT;
