...
OmgMeridianSwitcher::OmgMeridianSwitcher() : QObject()
{

}


OmgMeridianSwitcher::~OmgMeridianSwitcher() 
{
}

bool OmgMeridianSwitcher::doSwitch(QString theInputFileString, QString theOutputFileString)
{
  ...
  {
    emit error ("OmgMeridianSwitcher::Cannot open file : "+ theOutputFileString);
    return false;
  }
  else
  {
    myTextStream = new QTextStream(myFilePointer);
    emit message("OmgMeridianSwitcher::Opened file ... "+ theOutputFileString+" successfully.");
  }
  ...
  {
    //valid = FALSE;
    emit error ("OmgMeridianSwitcher::Cannot create gdal dataset: "+ theOutputFileString);
    return false;
  }
  ...
  {
    emit error ("OmgMeridianSwitcher::Error reading from gdal dataset: "+ theOutputFileString);
    return false;
  }
