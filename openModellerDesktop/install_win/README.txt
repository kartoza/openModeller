...
c:\Program Files\openModellerDesktop<version> (the old
c:\dev\cpp\omgui1\omgui-release path is deprecated)
...
openModellerDesktopSetup.exe /S
...
- if you wish to customise the datasets etc that are 
  ...
  installer - its in svn under openModellerDesktop/installer/
