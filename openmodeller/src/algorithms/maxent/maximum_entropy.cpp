 ...
 * $Id: maximum_entropy.cpp 6049 2015-04-01 11:47:19Z rdg $
 * 
 * LICENSE INFORMATION 
 * 
...
static AlgMetadata metadata = {
  ...
  "Steven J. Phillips, Miroslav Dud0xADk, Robert E. Schapire", // Algorithm authors.

  "1) Jaynes, E.T. (1957) Information Theory and Statistical Mechanics. In Physical Review, Vol. 106, #4 (pp 620-630). 2) Berger, A. L., Pietra, S. A. D. and Pietra, V. J. D. (1996). A maximum entropy approach to natural language processing. Computational Linguistics, 22, 39-71. 3) Darroch, J.N. and Ratcliff, D. (1972) Generalized iterative scaling for log-linear models. The Annals of Mathematical Statistics, Vol. 43: pp 1470-1480. 4) Malouf, R. (2003) A comparison of algorithms for maximum entropy parameter estimation. Proceedings of the Sixth Conference on Natural Language Learning. 5) Phillips, S.J., Dud0xADk, M. and Schapire, R.E. (2004) A maximum entropy approach to species distribution modeling. Proceedings of the Twenty-First International Conference on Machine Learning, pp 655-662.", // Bibliography.
...
MaximumEntropy::searchAlpha( MxFeature * f, double alpha )
{
  ...
  while ( true ) {
    ...
    if ( !isfinite(tentative_loss) || tentative_loss >= current_loss ) {
