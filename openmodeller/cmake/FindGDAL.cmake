    ...
    IF (APPLE)
      IF (CMAKE_FIND_FRAMEWORK MATCHES "FIRST"
        ...
        IF (GDAL_LIBRARY)
          ...
          IF (GDAL_VERSION_MAJOR LESS 1 OR (GDAL_MAJOR_VERSION EQUAL 1 AND GDAL_VERSION_MINOR LESS 4))
            MESSAGE (FATAL_ERROR "GDAL version is too old (${GDAL_VERSION}). Use 1.4.0 or higher.")
          ENDIF (GDAL_VERSION_MAJOR LESS 1 OR (GDAL_MAJOR_VERSION EQUAL 1 AND GDAL_VERSION_MINOR LESS 4))
        ENDIF (GDAL_LIBRARY)
